...
public class CustomOAuth2LoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public CustomOAuth2LoginAuthenticationFilter(
        ...
        this.authorizationSuccessHandler = (authorizedClient, authentication, attributes) -> authorizedClientRepository
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
         ...
         * hasTokenExpired(oAuth2AuthorizedClient.getAccessToken())
         * && oAuth2AuthorizedClient.getRefreshToken() != null) {
         * ClientRegistration.withClientRegistration(oAuth2AuthorizedClient.
         * getClientRegistration()).authorizationGrantType(AuthorizationGrantType.
         * REFRESH_TOKEN);
